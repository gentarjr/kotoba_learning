...
@Entity
public class KataKerjaEntity {

    @PrimaryKey(autoGenerate = true)
    private final int id_katakerja;
    ...
    public KataKerjaEntity(int id_katakerja, String kata_cina, String eja_kata, String kata_indo, String suara) {
        this.id_katakerja = id_katakerja;
